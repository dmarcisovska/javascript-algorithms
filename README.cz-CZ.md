...
Tento repozitář obsahuje příklady mnoha populárních algoritmů a datových struktur
 realizovaných v JavaScriptu.

Každý algoritmus a datová struktura mají vlastní README soubor
 s vysvětlením a odkazy na další zdroje (včetně odkazů na videa na YouTube).

_Přečtěte si tento dokument v dalších jazycích:_
...
*☝  Upozornění: Tento projekt je určen pouze pro studijní a výzkumné účely, není určen pro produkční nasazení.
